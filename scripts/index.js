...
const popupProfileNameInput = popupProfile.querySelector('.popup-profile__input_name');
const popupProfileDescriptionInput = popupProfile.querySelector('.popup-profile__input_description')
const profileName = profile.querySelector('.profile__name');
const profileDescription = profile.querySelector('.profile__description');
const elements = document.querySelector('.elements');
const cardNameInput = popupCard.querySelector('.popup-cards__input_name');
const cardLinkInput = popupCard.querySelector('.popup-cards__input_description');
